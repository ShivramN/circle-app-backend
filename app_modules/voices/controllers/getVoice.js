...
const getVoice = (req, res) => {
  ...
  validate.checkPagination(req.query)
    ...
    .then(data => {
      __logger.info('getVoice function', data)
      if (data && data.viewVoice) {
        limit = req.query.limit >= '5' ? parseInt(req.query.limit) : 100
        page = req.query.page ? parseInt(req.query.page) : 1
        return voiceService.checkUsersVoiceById(userId, limit, page, categoryId)
      } else {

...
const checkPointsHistory = (req, res) => {
  __logger.info('Inside checkPointsHistory')
  const userId = req.user && req.user.userId ? req.user.userId : '0'
  __db.mysql.query(__constants.MYSQL_NAME, queryProvider.getRedeemPoint(), [userId])
    .then(data => {
...
module.exports = checkPointsHistory

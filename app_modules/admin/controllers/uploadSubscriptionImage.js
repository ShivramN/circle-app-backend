...
const upload = require('../../../lib/uploads').uploadSubcription

const uploadSubscriptionImage = (req, res) => {
  __logger.info('inside uploadSubscriptionImage :: ')
  req.bucketName = __config.subcription
  upload(req, res, function (err, data) {
    ...
    if (!req.file) {
      ...
      return __util.send(res, { type: __constants.RESPONSE_MESSAGES.SUCCESS, data: { planLocation: req.file.location } })
    }
  })
}

module.exports = uploadSubscriptionImage
